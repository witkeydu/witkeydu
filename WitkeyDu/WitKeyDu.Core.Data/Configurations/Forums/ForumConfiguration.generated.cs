...
//     重新生成代码，这些更改将会丢失。
//		如存在本生成代码外的新需求，请在相同命名空间下创建同名分部类实现 ForumConfigurationAppend 分部方法。
// </auto-generated>
//------------------------------------------------------------------------------
...
namespace WitKeyDu.Core.Data.Configurations.Forums
{
    ...
    /// 实体类-数据表映射——论坛帖信息
    /// </summary>    
	internal partial class ForumConfiguration : EntityTypeConfiguration<Forum>, IEntityMapper
    {
        /// <summary>
        /// 实体类-数据表映射构造函数——论坛帖信息
        /// </summary>
