(function ($) {
    ...
    $(function () {
        ...
        if (!WebUploader.Uploader.support('flash') && WebUploader.browser.ie) {
            ...
            if (flashVersion) {
                (function (container) {
                    ...
                    var swf = '../Content/RefrenceFile/WebUploder/other/expressInstall.swf';
                    // insert flash object
        ...
        uploader = WebUploader.create({
            ...
            dnd: '#dndArea',
            paste: '#uploader',
            swf: '../Content/RefrenceFile/WebUploder/other/Uploader.swf',
            chunked: true, //分片处理大文件
            chunkSize: 2 * 1024 * 1024,
            server: '../Content/RefrenceFile/WebUploder/other/fileupload.ashx',
            disableGlobalDnd: true,
            threads: 1, //上传并发数
            //由于Http的无状态特征，在往服务器发送数据过程传递一个进入当前页面是生成的GUID作为标示
            formData: { guid: GUID, fileCode: $("input.fileCode").val() },
            fileNumLimit: 300,
...
//            if (response.chunked) {
//                $.post("../Content/RefrenceFile/WebUploder/other/MergeFiles.ashx", { guid: GUID, fileExt: response.f_ext },
//                function (data) {
//                    data = $.parseJSON(data);
//                    if (data.hasError) {
//                        alert('文件合并失败！');
